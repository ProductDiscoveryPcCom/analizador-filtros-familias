...
def render_config_tab():
    ...
    base_url = st.text_input(
        ...
        value=st.session_state.get('family_metadata', {}).base_url if st.session_state.get('family_metadata') else "",
...
def render_facets_tab():
    ...
    keywords = get_data_by_key('semrush') or get_data_by_key('keyword_planner')
    ...
    # URL base
    base_url = ""
    if st.session_state.get('family_metadata'):
        base_url = st.session_state['family_metadata'].base_url
