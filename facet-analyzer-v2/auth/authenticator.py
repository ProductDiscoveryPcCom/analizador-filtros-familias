...
class EmailAuthenticator:
    ...
    def _send_email(self, to_email: str, code: str):
        ...
        msg['Subject'] = f'Codigo de acceso: {code}'
...
Tu codigo de acceso a Facet Architecture Analyzer es:
...
<body>
    <div class="container">
        ...
        <p>Tu codigo de acceso a <strong>Facet Architecture Analyzer</strong> es:</p>
        
        <div class="code-box">
            <span class="code">{code}</span>
        </div>
        
        <p>Este codigo expira en <strong>{CODE_EXPIRY_MINUTES} minutos</strong>.</p>
        
        <p>Si no solicitaste este codigo, ignora este email.</p>
