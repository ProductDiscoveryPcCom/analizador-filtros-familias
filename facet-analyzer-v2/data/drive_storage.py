"""
Integración con Google Drive para persistencia de biblioteca - v2.2
...
class GoogleDriveStorage:
    ...
    def __init__(self, credentials_json: str = None, folder_id: str = None):
        ...
        # Intentar cargar desde secrets/env
        self._load_config()
    ...
    def _initialize(self):
        ...
        try:
            ...
            pass  # google-api-python-client no instalado
...
def render_drive_config_ui():
    ...
    if drive.is_configured():
        ...
        with col1:
            creds = st.text_area("Credenciales JSON", height=100, placeholder='{"type": "service_account", ...}')
